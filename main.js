  ...
  card.innerHTML = `
    ...
    <div class="p-5">
      ...
      <div class="flex gap-3 flex-wrap">
        ...
        <button
          class="return-btn hidden py-2 px-3 border-1 border-indigo-600 text-indigo-600 font-medium rounded-xl shadow-md cursor-pointer transition-all duration-300 hover:bg-indigo-600 hover:text-white"
        >
          Kembalikan
        </button>
      </div>
